...
**The hub:** `github.com/theunisdk/codex-review-kit`.
Prefer a local clone if one exists (commonly `~/dev/private/codex-review-kit`);
the public GitHub repo is the fallback and always works.
